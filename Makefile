...
fetch:
	$(PYTHON_INTERPRETER) sdg_mapping/fetch_data.py
	make sync_data_to_s3

## Sync raw from s3 and make Dataset
data:
	sync_data_from_s3
	$(PYTHON_INTERPRETER) sdg_mapping/make_dataset.py
...
lint:
	black sdg_mapping; flake8 sdg_mapping
